...
public class HelloController {
    ...
    public void onSubmitButtonClick() {
        ...
        SharedComponents.server.registerPlayer(playerNameField.getText());
        if (!SharedComponents.server.isOpen()) {
            Alert alert = new Alert(Alert.AlertType.WARNING);
    ...
    private void sendStatistics() {
        ...
        var result = new GameStatistics(SharedComponents.settings.playerName, GameController.madeMovesCounter,
                time, finish.format(dtFormatter));
        SharedComponents.server.sendResult(result);
    }
